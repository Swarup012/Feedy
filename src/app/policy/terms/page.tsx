        ...
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            Object.values(navRefs.current).forEach((el) =>
              el?.classList.remove("tos-active"),
            );
            const id = entry.target.getAttribute("id");
            if (id && navRefs.current[id])
              navRefs.current[id]?.classList.add("tos-active");
          }
        });
      },
      ...
      <div className="tos-wrap">
        ...
        <main className="tos-main">
          <header className="tos-header">
            ...
            <InfoBox>
              Please read these Terms carefully before using Faddy. By accessing
              or using our Services, you agree to be legally bound by these
          ...
          <section className="tos-section" id="agreement">
            ...
            <P>
              Faddy is a service operated by <strong>Swarup Basu</strong>, a
              sole proprietor based in India, providing a role-based,
              multi-tenant user feedback management platform at{" "}
              <a href="https://faddy.site" className="tos-link">
                faddy.site
              </a>
              . Faddy helps businesses and developers collect, track, and
              organise user feedback across teams and organisations.
            </P>
            <P>
              These Terms of Service ("<strong>Terms</strong>") constitute a
              legally binding agreement between you ("<strong>User</strong>" or
              "<strong>you</strong>") and Swarup Basu, sole proprietor,
              operating as Faddy ("<strong>Faddy</strong>," "<strong>we</strong>
              ," "<strong>us</strong>," or "<strong>our</strong>"), governing
              your access to and use of our website, platform, and any related
              services (collectively, the "<strong>Services</strong>").
            </P>
            <P>
              By using the Services, you confirm that you are at least 18 years
              old, have read and understood these Terms, and agree to be bound
              by them.{" "}
              <strong>
            ...
            <P>
              ...
              material changes via email to{" "}
              <a href="mailto:info@faddy.site" className="tos-link">
                info@faddy.site
              </a>{" "}
              or through an in-app notice. Continued use of the Services after
          ...
          <section className="tos-section" id="services">
            ...
            <P>
              Faddy provides a SaaS feedback management platform. Our Services
              are intended for use in accordance with applicable law. If your
              jurisdiction restricts any aspect of the Services, you are
              responsible for compliance with local laws.
            </P>
            <P>
              The Services are not tailored to comply with industry-specific
              regulations such as HIPAA or FISMA. If your use would be subject
              to such laws, you may not use the Services.
            </P>
          </section>
          ...
          <section className="tos-section" id="ip">
            ...
            <P>
              ...
              including source code, databases, software, designs, text,
              graphics, and logos (collectively, "<strong>Content</strong>") and
              all trademarks and service marks ("<strong>Marks</strong>"). Our
              Content and Marks are protected by applicable copyright,
              trademark, and other intellectual property laws.
            </P>
            <P>
              Subject to your compliance with these Terms, we grant you a
              limited, non-exclusive, non-transferable, revocable licence to
              access the Services for your personal or internal business use
              only. No part of the Services may be copied, reproduced,
              distributed, sold, or exploited for commercial purposes without
              our prior written permission.
            </P>
            <Sub title="Your submissions" />
            <P>
              By sending us feedback, suggestions, or other submissions, you
              assign to us all intellectual property rights in such submissions.
              We may use them freely without any obligation to compensate you.
            </P>
          </section>
          ...
          <section className="tos-section" id="userreps">
            ...
            />
            <P>
              If you provide false information, we have the right to suspend or
          ...
          <section className="tos-section" id="userreg">
            ...
            <P>
              ...
              reclaim usernames we deem inappropriate at our sole discretion.
            </P>
          </section>
          ...
          <section className="tos-section" id="purchases">
            ...
            <P>
              ...
              , who acts as our Merchant of Record. Paddle handles all payment
              processing, billing, and related compliance. By purchasing, you
              also agree to{" "}
              <a
            ...
            <P>
              Accepted payment methods include all major credit/debit cards and
              payment options supported by Paddle. You agree to provide accurate
              and complete billing information and authorise recurring charges
              where applicable.
            </P>
            <P>
              We reserve the right to refuse any order and to correct pricing
              errors at any time.
            </P>
          </section>
          ...
          <section className="tos-section" id="subscriptions">
            ...
            <P>
              Your subscription will automatically renew unless cancelled. You
              consent to recurring charges without prior approval for each
              cycle. The billing period depends on the plan you selected at
              sign-up.
            </P>
            <Sub title="Free Trial" />
            <P>
              We offer a 7-day free trial for new users. At the end of the
              trial, your account will be charged according to your chosen
              subscription plan unless you cancel before the trial ends.
            </P>
            <Sub title="Cancellation" />
            <P>
              You may cancel your subscription at any time from your account
              settings. Cancellation takes effect at the end of the current
              billing period. All purchases are non-refundable except as set out
              in our{" "}
              <a href="/policy/refund" className="tos-link">
                Refund Policy
              </a>
              . For questions, email{" "}
              <a href="mailto:support@faddy.site" className="tos-link">
                support@faddy.site
              </a>
              .
            </P>
            ...
            <P>
              We may change subscription fees from time to time and will notify
          ...
          <section className="tos-section" id="prohibited">
            ...
            <P>
              ...
              intended. As a user, you agree not to:
            </P>
            <UL
              items={[
          ...
          <section className="tos-section" id="ugc">
            ...
            <P>
              The Services may allow you to submit, post, or transmit content ("
              <strong>Contributions</strong>"). By posting Contributions, you
              grant us a worldwide, irrevocable, royalty-free licence to use,
              reproduce, modify, publish, and distribute such content for any
              purpose.
            </P>
            <P>
              You represent that your Contributions are original, do not
              infringe any third-party rights, and comply with these Terms. You
              are solely responsible for your Contributions. We reserve the
              right to remove any Contributions at any time without notice.
            </P>
          </section>
          ...
          <section className="tos-section" id="sitemanage">
            ...
            <P>
              ...
              Services for violations; take appropriate legal action; restrict
              or disable access to any Contributions; and otherwise manage the
              Services to protect our rights and ensure proper functioning.
            </P>
          </section>
          ...
          <section className="tos-section" id="privacy">
            ...
            <P>
              ...
              <a href="/policy/privacy" className="tos-link">
                Privacy Policy
              </a>
              , which is incorporated into these Terms. By using the Services,
              you agree to our Privacy Policy. Our servers are located in India
          ...
          <section className="tos-section" id="termination">
            ...
            <P>
              ...
              at our sole discretion and without notice or liability, terminate
              your access for any reason, including breach of these Terms.
            </P>
            <P>
              If your account is terminated, you are prohibited from creating a
              new account under any name without our express permission. We also
          ...
          <section className="tos-section" id="modifications">
            ...
            <P>
              ...
              the Services at any time without notice. We are not liable for any
              modification, suspension, or discontinuance of the Services.
            </P>
            <P>
              We cannot guarantee uninterrupted availability. We may experience
              downtime for maintenance or other reasons without liability to
              you.
            </P>
          </section>
          ...
          <section className="tos-section" id="law">
            ...
            <P>
              ...
              laws of <strong>India</strong>. You and Faddy irrevocably consent
              to the exclusive jurisdiction of the courts of India to resolve
              any dispute arising in connection with these Terms.
            </P>
          </section>
          ...
          <section className="tos-section" id="disputes">
            ...
            <P>
              Before initiating any formal proceedings, the parties agree to
              attempt to resolve any dispute informally for at least{" "}
              <strong>30 days</strong> via written notice.
            </P>
            <Sub title="Binding Arbitration" />
            <P>
              Any unresolved dispute shall be submitted to binding arbitration
              in <strong>Kolkata, India</strong>. Proceedings shall be conducted
              in English. The substantive law of India shall apply.
            </P>
            <Sub title="Restrictions" />
            <P>
              All arbitration shall be conducted on an individual basis. No
              class-action or representative proceedings are permitted.
            </P>
          </section>
          ...
          <section className="tos-section" id="liability">
            ...
            <div className="tos-warn">
              IN NO EVENT SHALL FADDY, ITS OPERATOR, EMPLOYEES, OR AGENTS BE
              LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR
              PUNITIVE DAMAGES. OUR TOTAL LIABILITY TO YOU FOR ANY CAUSE SHALL
              NOT EXCEED THE GREATER OF THE AMOUNT YOU PAID TO US IN THE 12
              MONTHS PRECEDING THE CLAIM OR ₹500 INR.
            </div>
          </section>
          ...
          <section className="tos-section" id="indemnification">
            ...
            <P>
              You agree to defend, indemnify, and hold harmless Faddy and its
              operator, employees, and agents from any loss, damage, liability,
              or claim arising from: (1) your Contributions; (2) your use of the
              Services; (3) breach of these Terms; (4) violation of third-party
              rights; or (5) any harmful act toward another user.
            </P>
          </section>
          ...
          <section className="tos-section" id="misc">
            ...
            <P>
              ...
              Faddy. Our failure to enforce any right or provision shall not be
              a waiver of that right. If any provision is found unenforceable,
              the remaining provisions remain in full effect.
            </P>
            <P>
              We may assign our rights and obligations under these Terms to
              others at any time. There is no joint venture, partnership, or
          ...
          <section className="tos-section" id="contact">
            ...
            <P>
              If you have questions about these Terms or need to resolve a
