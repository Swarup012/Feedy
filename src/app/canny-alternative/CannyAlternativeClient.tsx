                ...
                {item.dropdown ? (
                  <div>
                    ...
                    {item.dropdown.map((section, sIdx) => (
                      <div key={`mobile-section-${sIdx}`} className="ml-4 mt-3">
                        <div className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">
                          {section.section}
                        </div>
                        <div className="space-y-2">
                          {section.items.map((dropdownItem, iIdx) => (
                            <a
                              key={`mobile-dropdown-${iIdx}`}
                  ...
                  <a
                    href={item.link}
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="block text-lg font-medium text-neutral-600 dark:text-neutral-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                  >
                    {item.name}
                  </a>
                )}
