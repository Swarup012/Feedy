  ...
  return (
    <div className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <ul className="space-y-2 text-slate-600 dark:text-slate-400 mb-4">
        <li>Messages from a Slack channel are automatically analyzed for feedback</li>
        ...
        <CardContent className="p-6">
          <ol className="space-y-4 text-slate-600 dark:text-slate-400">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                Find the <strong>Slack</strong> card and click{" "}
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                You&rsquo;ll be redirected to Slack. Review the permissions and
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                <strong>&ldquo;Slack connected&rdquo;</strong>.
              </span>
            </li>
          </ol>
        </CardContent>
      ...
      <p className="text-slate-600 dark:text-slate-400 mb-4">
        After connecting, click <strong>Manage</strong> on the Slack card to
        configure:
      </p>
      ...
      <p className="text-slate-600 dark:text-slate-400 mb-4">
        Use the <strong>Monitored Channel</strong> dropdown to pick which Slack
        channel Faddy should watch.
      </p>
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
        <strong>Important:</strong> Invite the Feedy bot to this channel so it
        can receive messages. In Slack, type{" "}
        <code>/invite @Feedy</code> (or whatever the bot is named in your
        workspace).
      </p>
      ...
      <p className="text-slate-600 dark:text-slate-400 mb-4">
        ...
        receives feedback from this Slack channel. This is required for
        Automatic mode.
      </p>
      ...
      <p className="text-slate-600 dark:text-slate-400 mb-4">
        Click <strong>Disconnect Slack</strong> in the Manage popover. Faddy
        will stop monitoring the channel. This does not remove the Feedy bot
        from your Slack workspace — you can remove it manually from Slack if
        desired.
      </p>
            ...
            <Card className="group hover:shadow-lg transition-all border hover:border-purple-300 dark:hover:border-purple-700">
              <CardContent className="p-4">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                  Review and approve Slack-sourced suggestions
                </p>
              </CardContent>
            </Card>
          </Link>
          <Link href="/docs/features/alerts">
            <Card className="group hover:shadow-lg transition-all border hover:border-purple-300 dark:hover:border-purple-700">
              <CardContent className="p-4">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                  Send urgent alerts to a Slack channel
                </p>
              </CardContent>
            </Card>
          </Link>
