...
const navigation = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Triage Feedback", href: "/docs/features/triage" },
      { title: "Post Labels", href: "/docs/features/labels" },
      { title: "Roadmap", href: "/docs/features/roadmap" },
      { title: "Changelog", href: "/docs/features/changelog" },
      { title: "Autopilot", href: "/docs/features/autopilot" },
      { title: "AI Chat", href: "/docs/features/ai-chat" },
      { title: "High-Severity Alerts", href: "/docs/features/alerts" },
      { title: "Feedback Widget", href: "/docs/features/widget" },
      { title: "Job Roles", href: "/docs/features/job-roles" },
      { title: "Team & Permissions", href: "/docs/features/team" },
      { title: "Connect Slack", href: "/docs/features/slack" },
      { title: "Connect Discord", href: "/docs/features/discord" },
      { title: "Connect Intercom", href: "/docs/features/intercom" },
      { title: "Connect GitHub", href: "/docs/features/github" },
      { title: "How to Submit Feedback", href: "/docs/features/submitting-feedback" },
      { title: "How to Vote & Comment", href: "/docs/features/voting-commenting" },
      { title: "How to Follow the Roadmap", href: "/docs/features/following-roadmap" },
      { title: "How to Read the Changelog", href: "/docs/features/reading-changelog" },
      { title: "How to Use the Widget", href: "/docs/features/using-widget" },
    ],
  },
  {
    title: "Plans & Billing",
