          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-16">
              ...
              <div className="hidden md:block w-full lg:w-[54%] relative">
                {/* Decorative glow */}
                <div className="absolute -inset-6 bg-blue-400/10 blur-3xl rounded-3xl -z-10" />
                <div className="relative rounded-2xl overflow-hidden border border-slate-200/80 dark:border-slate-700/80 shadow-2xl shadow-slate-900/10 dark:shadow-slate-900/40">
                  {/* Fake browser chrome */}
