                ...
                <div className="relative rounded-2xl overflow-hidden border border-slate-200/80 dark:border-border bg-slate-50 dark:bg-background">
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="bg-white dark:bg-card border border-slate-200 dark:border-border rounded-2xl rounded-tl-sm px-4 py-3 max-w-[85%] text-sm text-slate-700 dark:text-muted-foreground">
                        <p className="mb-2">
                        ...
                        <ul className="list-disc list-inside space-y-1 text-slate-600 dark:text-muted-foreground">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="space-y-6">
              {prompts.map((prompt, idx) => (
                <Card
                  key={idx}
                  className="bg-white dark:bg-background border-slate-200 dark:border-border overflow-hidden"
                >
                  <CardContent className="p-0">
                    <div className="p-4 bg-slate-50 dark:bg-card/50 border-b border-slate-200 dark:border-border">
                      <div className="flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-muted-foreground">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {features.map((feature) => (
                <Card
                  key={feature.title}
                  className="bg-slate-50 dark:bg-background border-slate-200 dark:border-border hover:shadow-lg transition-all"
                >
