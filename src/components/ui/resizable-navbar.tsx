...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-full flex-row items-center justify-between self-start rounded-full px-8 py-3 lg:flex bg-white/80 dark:bg-neutral-950/80",
...
export const NavbarLogo = () => {
  return (
    ...
    >
      ...
      <span className="font-bold text-xl text-blue-600">Faddy</span>
    </a>
  );
};
