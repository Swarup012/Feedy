              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                ...
                <tbody className="bg-white dark:bg-card divide-y divide-gray-200 dark:divide-gray-800">
                  ...
                  <tr>
                    ...
                    <td className="py-4 px-6 text-center text-sm text-gray-500">-</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300 bg-blue-50/50 dark:bg-blue-900/10">$6 per 50 users</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300">$6 per 50 users</td>
                  </tr>
                  <tr>
