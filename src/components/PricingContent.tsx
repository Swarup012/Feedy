      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <Card className="relative">
          ...
          <CardContent>
            ...
            >
              {!user ? "Get started" : currentPlan === "free" ? "Current Plan" : "Downgrade"}
            </Button>
        ...
        <Card className="relative">
          <CardHeader>
            ...
            <div className="mb-2">
              {billingCycle === "monthly" ? (
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold">${starterPlan.monthlyPrice}</span>
                  <span className="text-gray-600 dark:text-gray-400">/month</span>
                </div>
              ) : (
                <div>
                  <div className="flex items-baseline gap-1">
                    <span className="text-4xl font-bold">${starterPlan.yearlyPrice}</span>
                    <span className="text-gray-600 dark:text-gray-400">/month</span>
                  </div>
        ...
        <Card className="relative border-2 border-blue-500 shadow-xl">
          ...
          <CardHeader>
            ...
            <div className="mb-2">
              {billingCycle === "monthly" ? (
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold">${proPlan.monthlyPrice}</span>
                  <span className="text-gray-600 dark:text-gray-400">/month</span>
                </div>
              ) : (
                <div>
                  <div className="flex items-baseline gap-1">
                    <span className="text-4xl font-bold">${proPlan.yearlyPrice}</span>
                    <span className="text-gray-600 dark:text-gray-400">/month</span>
                  </div>
                  <div className="text-sm text-blue-600 mt-1">
            ...
            <div className="overflow-hidden border border-gray-200 dark:border-gray-800 rounded-lg">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                <thead className="bg-gray-50 dark:bg-gray-900">
                  <tr>
                    <th scope="col" className="py-4 px-6 text-left text-sm font-semibold text-gray-900 dark:text-white">Features</th>
                    <th scope="col" className="py-4 px-6 text-center text-sm font-semibold text-gray-900 dark:text-white">Free</th>
                    <th scope="col" className="py-4 px-6 text-center text-sm font-semibold text-gray-900 dark:text-white bg-blue-50 dark:bg-blue-900/20">
                      <div className="flex items-center justify-center gap-2">
                        <Crown className="w-4 h-4 text-blue-600" />
                        Starter
                      </div>
                    </th>
                    <th scope="col" className="py-4 px-6 text-center text-sm font-semibold text-gray-900 dark:text-white">Pro</th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-card divide-y divide-gray-200 dark:divide-gray-800">
                  {/* Pricing */}
                  <tr className="bg-gray-50 dark:bg-gray-900/50">
                    <td colSpan={4} className="py-3 px-6 text-sm font-semibold text-gray-900 dark:text-white">Pricing</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Monthly Price</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-900 dark:text-white font-semibold">$0</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-900 dark:text-white font-semibold bg-blue-50/50 dark:bg-blue-900/10">${starterPlan.monthlyPrice}</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-900 dark:text-white font-semibold">${proPlan.monthlyPrice}</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Yearly Price (save ${starterPlan.savings})</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-500">-</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-900 dark:text-white font-semibold bg-blue-50/50 dark:bg-blue-900/10">${starterPlan.yearlyPrice}/mo</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-900 dark:text-white font-semibold">${proPlan.yearlyPrice}/mo</td>
                  </tr>

                  {/* Team Collaboration */}
                  <tr className="bg-gray-50 dark:bg-gray-900/50">
                    <td colSpan={4} className="py-3 px-6 text-sm font-semibold text-gray-900 dark:text-white">Team & Collaboration</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Team Members</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300">3 total members</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/10">Unlimited</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400">Unlimited</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Admin Roles</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300">Included in 3</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/10">Up to 5 admins</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400">Up to 10 admins</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Role-Based Permissions</td>
                    <td className="py-4 px-6 text-center"><Check className="w-5 h-5 text-green-500 mx-auto" /></td>
                    <td className="py-4 px-6 text-center bg-blue-50/50 dark:bg-blue-900/10"><Check className="w-5 h-5 text-green-500 mx-auto" /></td>
                    <td className="py-4 px-6 text-center"><Check className="w-5 h-5 text-green-500 mx-auto" /></td>
                  </tr>

                  {/* Feedback Management */}
                  <tr className="bg-gray-50 dark:bg-gray-900/50">
                    <td colSpan={4} className="py-3 px-6 text-sm font-semibold text-gray-900 dark:text-white">Feedback Management</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Feedback Boards</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300">3 boards</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/10">Unlimited</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400">Unlimited</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Posts per Board</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300">5 posts</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/10">Unlimited</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400">Unlimited</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Tracked Users</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300">20 users</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/10">125+ users</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400">125+ users</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Roadmap Items</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300">1 roadmap</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/10">1 roadmap</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400">Unlimited</td>
                  </tr>

                  {/* Features */}
                  <tr className="bg-gray-50 dark:bg-gray-900/50">
                    <td colSpan={4} className="py-3 px-6 text-sm font-semibold text-gray-900 dark:text-white">Features</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Custom Branding</td>
                    <td className="py-4 px-6 text-center"><X className="w-5 h-5 text-gray-300 mx-auto" /></td>
                    <td className="py-4 px-6 text-center bg-blue-50/50 dark:bg-blue-900/10"><Check className="w-5 h-5 text-green-500 mx-auto" /></td>
                    <td className="py-4 px-6 text-center"><Check className="w-5 h-5 text-green-500 mx-auto" /></td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Custom Domain</td>
                    <td className="py-4 px-6 text-center"><X className="w-5 h-5 text-gray-300 mx-auto" /></td>
                    <td className="py-4 px-6 text-center bg-blue-50/50 dark:bg-blue-900/10"><X className="w-5 h-5 text-gray-300 mx-auto" /></td>
                    <td className="py-4 px-6 text-center"><span className="text-sm font-semibold text-blue-600 dark:text-blue-400">1 subdomain</span></td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Analytics</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300">Basic</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/10">Advanced</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400">Advanced</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Priority Support</td>
                    <td className="py-4 px-6 text-center"><X className="w-5 h-5 text-gray-300 mx-auto" /></td>
                    <td className="py-4 px-6 text-center bg-blue-50/50 dark:bg-blue-900/10"><X className="w-5 h-5 text-gray-300 mx-auto" /></td>
                    <td className="py-4 px-6 text-center"><Check className="w-5 h-5 text-green-500 mx-auto" /></td>
                  </tr>
                  ...
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Advanced Security</td>
                    <td className="py-4 px-6 text-center"><X className="w-5 h-5 text-gray-300 mx-auto" /></td>
                    <td className="py-4 px-6 text-center bg-blue-50/50 dark:bg-blue-900/10"><X className="w-5 h-5 text-gray-300 mx-auto" /></td>
                    <td className="py-4 px-6 text-center"><Check className="w-5 h-5 text-green-500 mx-auto" /></td>
                  </tr>
                  ...
                  {/* Overage & Billing */}
                  <tr className="bg-gray-50 dark:bg-gray-900/50">
                    <td colSpan={4} className="py-3 px-6 text-sm font-semibold text-gray-900 dark:text-white">Overage & Billing</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Overage Allowed</td>
                    <td className="py-4 px-6 text-center"><X className="w-5 h-5 text-gray-300 mx-auto" /></td>
                    <td className="py-4 px-6 text-center bg-blue-50/50 dark:bg-blue-900/10"><Check className="w-5 h-5 text-green-500 mx-auto" /></td>
                    <td className="py-4 px-6 text-center"><Check className="w-5 h-5 text-green-500 mx-auto" /></td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Grace Buffer</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-500">-</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300 bg-blue-50/50 dark:bg-blue-900/10">20% (25 users)</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300">20% (25 users)</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Overage Price</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-500">-</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300 bg-blue-50/50 dark:bg-blue-900/10">$12 per 50 users</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-700 dark:text-gray-300">$12 per 50 users</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-sm text-gray-900 dark:text-white">Free Trial</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-500">-</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/10">14 days</td>
                    <td className="py-4 px-6 text-center text-sm font-semibold text-blue-600 dark:text-blue-400">14 days</td>
                  </tr>
                </tbody>
              </table>
            </div>
